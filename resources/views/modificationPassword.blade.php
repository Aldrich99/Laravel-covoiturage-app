...
@include('Menu.Menubar')
	<div class="page-content">
		<div class="form-v4-content">
			...
			<form class="form-detail" action="/modificationPassword" method="post" id="myform">
			{{csrf_field()}}
				<h2>Connexion</h2>

				<div class="form-row">
					<label for="your_email">Numero de telephone</label> 	
					<input type="tel" name="telephone" id="telephone" class="input-text" required pattern="[0-9]{2}[0-9]{3}[0-9]{2}[0-9]{2}" placeholder="taper votre numero">
				...
				<div class="form-group">
					<div class="form-row  ">
						...
						<input type="password" name="password" id="password" class="input-text" placeholder="Taper un nouveau mot de passe" required>
