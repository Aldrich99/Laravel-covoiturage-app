...
<div class="container-fluid pt-5" style="background-color: white;padding-bottom: 150px">
    <div class="col-lg-10 mx-auto " style="background-color: #ecf0f5;">
    	<div class="row p-4" style="background: #383c45;color: white;"><span style="width: auto;"><a href="/client" style="color: white;" data-toggle="tooltip" data-placement="top" title="Retour au tableau de bord"><i class="fa fa-backward"></i></a></span><span  style="width: auto;" class="mx-auto h3">RECHERCHER UN TRAJET</span></div>
                	...
                	<div class="col-lg-10 " >
                        ...
                        <div >
                        	...
                        	{{csrf_field()}}
                        		<div class="row">
                        			<div class="col ">
                        				  <input list="ville_depart" name="ville_depart" id="ville_depart" class="form-control" placeholder="ville de depart" required="required">
                        			...
                        			<div class="col">
                        				  <input list="ville_arriver" name="ville_arriver" id="ville_arriver" class="form-control" placeholder="Ville d'arriver" required="required">
                        			...
                        			<div class="col ">
                        				      <button class="btn btn-danger pull-right "  id="recherche" type="submit" style="color: white;">Rechercher </button>                        				
                        			</div>
