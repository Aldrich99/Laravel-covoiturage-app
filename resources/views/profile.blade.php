...
<div class="container-fluid pt-4" style="background-color: white;">
    <div class="col-lg-10 mx-auto " style="background-color: #ecf0f5;">
    	<div class="row p-4" style="background: #383c45;color: white;"><span style="width: auto;"><a href="/client" style="color: white;" data-toggle="tooltip" data-placement="top" title="Retour au tableau de bord"><i class="fa fa-backward"></i></a></span><span  style="width: auto;" class="mx-auto ">MON PROFILE</span></div>
        <div class="row" style="background-color: #fdf5bd;color: black;"><span style="width: auto;" class="mx-auto p-4 "> <span class="font-weight-bold">Modifier </span>ou <span class="font-weight-bold">ajouter</span> des information a votre profile !</span></div>        	
        	<div class="row offset-1 p-4" > 
        	
        	<div class="row">
        	<div class="col-lg-4 mx-auto">
        	@if(!empty($profile))
        		<img  src="/storage/{{$profile->photo_profile}}" class="rounded-circle " width="100px" height="100px">
        	@else
    		...
    		{{csrf_field()}}
    			<div class="row ">
    				<div class="col">
    					...
    					<input type="text" id="nom" name="nom" class="form-control disabled " placeholder="{{$profile->nom}}" >
    				</div>
    			...
    			<div class="row ">
    				<div class="col">
    					...
    					<input type="text" id="prenom" name="prenom" class="form-control"  placeholder="{{$profile->prenom}}">
    				</div>
